      ...
      <div className='w-full mx-auto lg:w-10/12'>
        ...
        <div className='grid grid-cols-1 xl:grid-cols-3 lg:grid-cols-3 md:grid-cols-3 mb-8 md:gap-8'>
         ...
         <div className='col-span-2'>
          ...
          <div className='w-full rounded-lg shadow-md bg-base-100 stats'>
            {location && (
              <div className='stat'>
                <div className='stat-titlle text-md'>Konum</div>
                <div className='text-lg stat-value'>{location}</div>
              </div> 
            )}
            {blog && (
              <div className='stat'>
                <div className='stat-titlle text-md'>Web Sitesi</div>
                <div className='text-lg stat-value'><a href={`https://${blog}`} target='_blank' rel='noreferrer'>{blog}</a></div>
              </div> 
            )}
            {twitter_username && (
              <div className='stat'>
                <div className='stat-titlle text-md'>Twitter</div>
        ...
        <div className='w-full py-5 mb-6 rounded-lg shadow-md bg-base-100 stats'>
          <div className='stat'>
            ...
            <div className='stat-title pr-5'>Takipçiler</div>
          ...
          <div className='stat'>
            ...
            <div className='stat-title pr-5'>Repolar</div>
          ...
          <div className='stat'>
            ...
            <div className='stat-title pr-5'>Gistler</div>
